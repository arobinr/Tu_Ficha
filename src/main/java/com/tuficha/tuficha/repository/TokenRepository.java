...
public interface TokenRepository extends CrudRepository<Token,Long> {
    ...
    @Query("SELECT new com.tuficha.tuficha.dto.Row( thi.id, thi.name, thi.identification, thi.phone, thi.rh, pro.id, pro.name, " +
            " af1.id, af1.name, af2.id, af2.name, sec.id, sec.name, cit.name ) " +
            "FROM Token tok " +
